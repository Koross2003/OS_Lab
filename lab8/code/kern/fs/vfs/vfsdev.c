...
static list_entry_t vdev_list;     // device info list in vfs layer//通过这个链表可以找到device对应的inode
static semaphore_t vdev_list_sem; // 互斥访问的semaphore,一个vdev_list对应一个sem
